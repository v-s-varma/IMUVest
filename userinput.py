...
dtw_source_object_save = "src_sig_dtw" # if not filled in, dtw does not run.
dtw_store_frames=20
...
enable_cwt = True
cwt_scale = 2
scale_type = "length"    #either "scale" or  "length"
cwt_source_obj_save= ''
cwt_detect_thresh = 300
cwt_gy_store_frames = 50
cwt_filter = False
cwt_dtect_thresh = 2000
...
## added by VSV dd/mm/yyyy=23-3-2023

#trip trigger variables
trip_type = 1    # 1= early, 2=mid, 3=late
trip_duration = 150    # milliseconds other values 250ms, 350ms
num_steps_to_trip = 3 #np.random.randint(5,10) 
leg_to_trip="right"    # or  "left based on which leg the rope is attached"
